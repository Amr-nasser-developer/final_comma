...
class ResearchScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(create: (context) => AppCubit()..getMaterialAndCvAndResearch(),
      child: BlocConsumer<AppCubit, AppStates>(
        listener: (context, state) {
          if(state is UploadResearchSuccess){
            ...
            body: Padding(
              ...
              child: Column(
                children: [
                  ...
                  if (state is UploadResearchLoading)CircularProgressIndicator(),
                  if (state is! UploadResearchLoading)
                    defaultAccessButton(
                        function: () {
